...
<div class="container-fluid">
    ...
    <div id="gallery" class="carousel slide float-left" data-ride="carousel" style="width: 600px; margin-right: 10px;">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/kachim-vysochaishyj1.jpg" class="d-block w-100" alt="1">
            </div>
            <div class="carousel-item">
                <img src="img/kachim-vysochaishyj2.jpg" class="d-block w-100" alt="2">
            </div>
        </div>
    ...
    <div class="list-group">
        ...
        <div class="list-group-item">
            Ссылки:
            <ul>
                <li><a href="http://redbooktula.ru/krasnaya-kniga/sosudistye-rasteniya/kachim-vysochayshiy/" target="_blank">Красная книга Тульской области</a></li>
            </ul>
        </div>
    </div>
</div>
